import { AccountInfo, AddressLookupTableAccount, AddressLookupTableProgram, PublicKey } from '@solana/web3.js';
...
class LookupTableProvider {
    ...
    private updateCache(lutAddress: PublicKey, lutAccount: AddressLookupTableAccount) {
    ...
    private processLookupTableUpdate(lutAddress: PublicKey, data: AccountInfo<Buffer>) {
    ...
    async getLookupTable(lutAddress: PublicKey): Promise<AddressLookupTableAccount | undefined | null> {
    ...
    computeIdealLookupTablesForAddresses(addresses: PublicKey[]): AddressLookupTableAccount[] {
